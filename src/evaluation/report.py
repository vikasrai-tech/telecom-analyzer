...
def generate_report(
    ...
    lines.append(f"# Unified Telecom Analyzer — Evaluation Report")
    lines.append(f"\nGenerated: {ts}")
    lines.append("\n---")
    lines.append("\n## Dataset Disclosure")
    ...
    if detection_results:
        ...
        lines.append("\nN=3 injected faults in 16 cells. Method evaluated by whether fault cells (PCI_3, PCI_12, PCI_8) are flagged.")
