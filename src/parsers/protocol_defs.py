...
NGAP_INITIAL_CONTEXT_SETUP_REQUEST_IES: List[IE] = [
    ...
    ie("RRC Inactive Transition Report Request", O, "ENUM", "TS 38.413 §9.3.1.72", "ngap.rRCInactiveTransitionReportRequest"),  # noqa: E501
...
NGAP_INITIAL_CONTEXT_SETUP_RESPONSE_IES: List[IE] = [
    ie("AMF-UE-NGAP-ID", M, "INTEGER", "TS 38.413 §9.3.3.1", "ngap.aMF_UE_NGAP_ID"),
    ie("RAN-UE-NGAP-ID", M, "INTEGER", "TS 38.413 §9.3.3.2", "ngap.rAN_UE_NGAP_ID"),
    ie("PDU Session Resource Setup Response List", O, "LIST", "TS 38.413 §9.3.4.1", "ngap.pDUSessionResourceSetupListCxtRes"),  # noqa: E501
    ie("PDU Session Resource Failed To Setup List", O, "LIST", "TS 38.413 §9.3.4.1", "ngap.pDUSessionResourceFailedToSetupListCxtRes"),  # noqa: E501
...
NGAP_INITIAL_CONTEXT_SETUP_FAILURE_IES: List[IE] = [
    ie("AMF-UE-NGAP-ID", M, "INTEGER", "TS 38.413 §9.3.3.1", "ngap.aMF_UE_NGAP_ID"),
    ie("RAN-UE-NGAP-ID", M, "INTEGER", "TS 38.413 §9.3.3.2", "ngap.rAN_UE_NGAP_ID"),
    ie("PDU Session Resource Failed List", O, "LIST", "TS 38.413 §9.3.4.1", "ngap.pDUSessionResourceFailedToSetupListCxtFail"),  # noqa: E501
...
NGAP_UE_CONTEXT_RELEASE_COMPLETE_IES: List[IE] = [
    ...
    ie("Information on Recommended Cells and RAN Nodes", O, "SEQUENCE", "TS 38.413 §9.3.1.30", "ngap.infoOnRecommendedCellsAndRANNodesForPaging"),  # noqa: E501
...
NGAP_HANDOVER_REQUEST_IES: List[IE] = [
    ...
    ie("UE History Information from the UE", O, "OCTET-STR", "TS 38.413 §9.3.1.62a", "ngap.uEHistoryInformationFromTheUE"),  # noqa: E501
]
...
F1AP_UE_CONTEXT_SETUP_REQUEST_IES: List[IE] = [
    ...
    ie("Resource-Coordination-Transfer-Container", O, "OCTET-STR", "TS 38.473 §9.3.1.38", "f1ap.resource_Coordination_Transfer_Container"),  # noqa: E501
    ...
    ie("RAT-FrequencyPriorityInformation", O, "CHOICE", "TS 38.473 §9.3.1.113", "f1ap.rAT_FrequencyPriorityInformation"),  # noqa: E501
...
E1AP_BEARER_CONTEXT_SETUP_REQUEST_IES: List[IE] = [
    ...
    ie("UE DL Maximum Integrity Protected Data Rate", O, "INTEGER", "TS 38.463 §9.3.1.67", "e1ap.uE_DL_Maximum_Integrity_Protected_Data_Rate"),  # noqa: E501
    ...
    ie("System Bearer Context Setup Request", M, "CHOICE", "TS 38.463 §9.3.1.42", "e1ap.system_Bearer_Context_Setup_Request"),  # noqa: E501
